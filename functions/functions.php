...
function rv_versioned_stylesheet($relative_url, $add_attributes=""){
  print '<link rel="stylesheet" href="http://' .$_SERVER['HTTP_HOST'].$GLOBALS["TEMPLATE_RELATIVE_URL"].rv_versioned_resource($relative_url).'" '.$add_attributes.'>'."\n";
}

// Add ?v=[last modified time] to javascripts
function rv_versioned_javascript($relative_url, $add_attributes=""){
  print '<script src="http://' .$_SERVER['HTTP_HOST'].$GLOBALS["TEMPLATE_RELATIVE_URL"].rv_versioned_resource($relative_url).'" '.$add_attributes.'></script>'."\n";
}

// Add ?v=[last modified time] to a file url
function rv_versioned_resource($relative_url){
  // todo: make theme name variable
  $file = $_SERVER["DOCUMENT_ROOT"]."/wp-content/themes/blomblom/".$relative_url;
  $file_version = "";
